...
if __name__ == "__main__":
    ...
    doc_true = f"{os.getcwd()}Application Assignments\\Infrrd-Assignment\\dataset\\dataset\\train\\boxes_transcripts_labels"
    
    doc_pred = f"{os.getcwd()}Application Assignments\\Infrrd-Assignment\\dataset\\dataset\\result\\boxes_transcripts_labels"
